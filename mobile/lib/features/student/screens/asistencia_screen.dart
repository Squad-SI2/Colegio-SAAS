...
class AsistenciaEstudianteScreen extends StatefulWidget {
  ...
  @override
  State<AsistenciaEstudianteScreen> createState() =>
      _AsistenciaEstudianteScreenState();
}

class _AsistenciaEstudianteScreenState
    extends State<AsistenciaEstudianteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Asistencia del Estudiante"),
      ),
      body: Column(
        children: [
          ...
          TableCalendar(
            ...
            calendarBuilders: CalendarBuilders(
              defaultBuilder: (context, day, focusedDay) {
                ...
                return null; // usa el estilo por defecto
              },
            ),
